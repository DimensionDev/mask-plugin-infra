declare module 'ts-results/result.js' {
    import { Option } from 'ts-results/option.js'
    ...
    export const Err: typeof ErrImpl & (<E>(err: E) => Err<E>)
    ...
    export const Ok: typeof OkImpl & (<T>(val: T) => Ok<T>)
